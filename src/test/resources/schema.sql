...
create table POST (post_id bigint not null auto_increment, author varchar(30), title text, category varchar(20), created_time datetime(6), last_modified_time datetime(6), recommendation_count integer, report_count integer, text text, view_count integer, primary key (post_id)) engine=InnoDB;
